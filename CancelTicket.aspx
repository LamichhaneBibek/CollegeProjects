<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="CancelTicket.aspx.cs" Inherits="example.CancelTicket" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
   <table align="center">
        <tr>
            <td>
               <strong> <asp:Label ID="lblheat" runat="server" Text="Cancel Tickets" Font-Size= "X-Large"  ForeColor="#F7990D"></asp:Label>
                    </strong>
           <br /> </td>
        </tr>
    </table>

<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="example.Contact" %>
                                        ...
                                        <td valign="middle" colspan="4" height="40">
                                            <table cellspacing="0" cellpadding="2" width="93%" border="0">
                                                <tbody>
                                                    ...
                                                    <tr valign="top" align="left">
                                                        <td>
                                                            <font size="3" color="#0066ff"><strong>Bibek Lamichhane</strong> </font>
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        </td>
                                                        <td>
                                                            <font size="3" color="#0066ff"><strong>Ram Sharma</strong> </font>
                                                        </td>
                                                    </tr>
                                                    <tr valign="top" align="left">
